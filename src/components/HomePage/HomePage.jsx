        ...
        const fetchCharacters = async (query) => {
            try {
                ...
                if (query) {
                    ...
                    params.limit = charactersPerPage;
                ...
                const responseCharacters = response.data.data.results.map((character) => ({
                    id: character.id,
                    name: character.name,
                ...
                setLoading(false);
                setLastPage(response.data.data.total / charactersPerPage);
    ...
    return (
        <div className={Styles.homePage}>
            ...
            <div className={Styles.paginationButtons}>
                <PaginationButtons page={currentPage} setPage={setCurrentPage} lastPage={lastPage} />
            </div>
        </div>
    );
};
